                    ...
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body text-center">
                            ...
                            <img class="img-thumbnail rounded-circle"
                                src="<?php echo BASE_URL . 'assets/img/apple-icon.png'?>" alt="" width="150">
                            <hr>
                            <p><i class="far fa-user"></i> Usuario: <?php echo $_SESSION['nombreCliente'] ?></p>
                            <p><i class="far fa-envelope"></i> Correo: <?php echo $_SESSION['correoCliente'] ?></p>
