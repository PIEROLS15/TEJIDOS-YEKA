...
class Clientes extends Controller
{
    ...
    public function enviarCorreo()
    {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('2101010200@undc.edu.pe', TITLE);
            ...
            $mensaje = array('msg' => 'Error al envia el correo electronico' .$mail->ErrorInfo, 'icono' => 'error');
        }
        } else {
    ...
    //Para ver pedidos pendientes en el modal 
